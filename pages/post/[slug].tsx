...
const Post = ({post}: Props) => {
    ...
    return (
        <main>
            ...
            {submitted ? (
                <div className='flex flex-col py-10 my-10 bg-blue-500 text-white max-w-2xl mx-auto'>
                    <h3 className='text-3xl mx-auto'>Your comment has been submitted!</h3>
                    <p className='mx-auto'>Once it has been approved, it will appear below.</p>
                </div>
            ) : (
